...
namespace Crystal
{
	EditorLayer::EditorLayer()
		: Layer("Editor Layer"), m_CameraController(16.0f / 9.0f, true)
	{
	}
	...
	void EditorLayer::OnAttach()
	{
		...
		m_SpriteTexture = Texture2D::Create("assets/textures/head.png");
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
...

		{
			...
			Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f, 0.1f }, { 1.0f, 1.0f }, rotation, m_SpriteTexture, 1.0f);
			Renderer2D::EndScene();
		}
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		// When using ImGuiDockNodeFlags_PassthruCentralNode, DockSpace() will render our background and handle the pass-thru hole, so we as Begin() to not render a background.
